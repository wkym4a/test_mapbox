...
class PointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post points_url, params: { point: { address: @point.address, latitude: @point.latitude, longitude: @point.longitude, name: @point.name } }
    end
  ...
  test "should update point" do
    patch point_url(@point), params: { point: { address: @point.address, latitude: @point.latitude, longitude: @point.longitude, name: @point.name } }
